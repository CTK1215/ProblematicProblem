    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (cont)
            {
                ...
                Console.Write($"Ah got it! {userName}, your random activity is: {randomActivity}! Is this ok or do you want to grab another activity? true (keep going) / false (you're done): ");
                Console.WriteLine();
                cont = bool.Parse(Console.ReadLine());
            }
        }
